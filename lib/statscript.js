...
function create (config) {
  ...
  ss.matrix = require('./utility/matrix.js');
  ...
  ss.numeric.polynomial = require('./numeric/polynomial.js');
  ...
  ss.distribution.poisson = require('./distribution/poisson.js');

  ss.sample = {};
  ss.sample.collection = require('./sample/collection.js');
  ss.sample.histogram = require('./sample/histogram.js');
  ss.sample.regression = require('./sample/regression.js');
